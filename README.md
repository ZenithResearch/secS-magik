...
- Solid on this I08 branch: a static trusted verification-key/circuit/public-input-schema registry and fail-closed metadata-tier gate. Matching active metadata emits only `proof_metadata_bound` / `proof_registry_checked`; this is not light-client or recursive proof verification. Those verifier rails remain gated by I18 and I19.
