...
- Planned next: replacement/reconciliation of the temporary wallet challenge contract with full Castalia Wallet wallet-core parity and evidence-aware live runtime ingress for `membership.provision`; #77 is only the fail-closed descriptor-only runtime guard.
