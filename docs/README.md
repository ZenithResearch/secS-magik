...
| [specs/dregg-authority-rail.md](specs/dregg-authority-rail.md) | Current M15.1 spec | Dregg authority rail spec for `dregg_authority`; #137 rewrote #73 acceptance, M15.2–M15.6 now provide a bounded static receiver-held policy-admission/operator-inspection seam, and #143/#144/#159/#160/#162 remain open for seam migration, final E2E, and live hardening. |
