...
| [specs/devgraph-issue-create-v1.md](specs/devgraph-issue-create-v1.md) | Operator-ratified P4-O-DG contract; runtime unimplemented | Exact contract for `devgraph.issue.create.v1`; it defines portable authority and receipt-correlation semantics but implements no runtime, Wallet, CLI, Devgraph, transport, or deployment surface. |
...
| [plans/2026-08-31-devgraph-issue-create-v1-dag.md](plans/2026-08-31-devgraph-issue-create-v1-dag.md) | P4-O-DG ratified; runtime unimplemented | Separate serialized contract-to-evidence sequence for the exact Devgraph Issue-create operation; DG-P is next. |
...
| [specs/devgraph-issue-create-v1.md](specs/devgraph-issue-create-v1.md) | Operator-ratified P4-O-DG contract; runtime unimplemented | Exact contract for one `Issue` create operation. It is Ed25519-only in v1, treats `.castaway` only as a vault, and ratifies no generic Work API or runtime mechanism. |
