...
| [specs/devgraph-issue-create-v1.md](specs/devgraph-issue-create-v1.md) | P4-O-DG-R1, DG-P, and DG-E1 merged; DG-E2 Wallet adapter on branch | Exact contract for `devgraph.issue.create.v1`; secS preserves the RFC 8785 vectors, and DG-E2 adds only a fixed one-shot local Wallet ceremony without generic routing/browser RPC or Work mutation. |
...
| [plans/2026-08-31-devgraph-issue-create-v1-dag.md](plans/2026-08-31-devgraph-issue-create-v1-dag.md) | P4-O-DG-R1, DG-P, and DG-E1 merged; DG-E2 partial branch evidence | Separate serialized contract-to-evidence sequence; DG-E2 proves only safe local Wallet-to-projection plumbing, not cross-repository Work success. |
...
| [specs/devgraph-issue-create-v1.md](specs/devgraph-issue-create-v1.md) | P4-O-DG-R1, DG-P, and DG-E1 merged; DG-E2 Wallet adapter on branch | Exact contract for one `Issue` create operation. The producer and bounded adapters preserve the RFC 8785 vectors, Ed25519-only v1, `.castaway`-as-vault boundary, and no generic Work API/browser RPC or route. |
