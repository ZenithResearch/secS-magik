...
These pages describe the current code and delivery surfaces. They are subordinate to the root [README](../../README.md) and must remain consistent with the authoritative [implementation status ledger](../implementation-status.md).
