...
|---|---|---|
| Track I `membership.provision` E2E | GitHub #70; future `phase/track-i-membership-provision-e2e` | Planned / next implementation after Track E merge; must prove packet construction, wallet + trusted issuer evidence composition, signed context, verify/execute receipts, and inspectable local/operator ledger rows. |
...
| Dregg / Midnight / Cardano authority rails | GitHub #73/#74/#75 | Future optional rails; labels/refs alone remain inert. |
