...
| [2026-08-31-devgraph-issue-create-v1-dag.md](2026-08-31-devgraph-issue-create-v1-dag.md) | P4-O-DG-R1 merged; DG-P implemented on #281; downstream blocked | Dedicated sequence `P4-R -> P4-O-DG -> P4-O-DG-R1 -> DG-P -> DG-V -> DG-W -> DG-C -> DG-E`; DG-P merge/green evidence is pending and every downstream node remains blocked. |
