...
| [2026-08-31-devgraph-issue-create-v1-dag.md](2026-08-31-devgraph-issue-create-v1-dag.md) | P4-O-DG-R1 and DG-P merged; DG-E1 partial branch evidence | Dedicated sequence `P4-R -> P4-O-DG -> P4-O-DG-R1 -> DG-P -> DG-V -> DG-W -> DG-C -> DG-E`; DG-E1 proves only safe local projection production and does not complete the cross-repository evidence node. |
