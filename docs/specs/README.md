...
| [devgraph-issue-create-v1.md](devgraph-issue-create-v1.md) | Operator-ratified `devgraph.issue.create.v1` contract with merged P4-O-DG-R1 vectors and merged DG-P; the DG-E1 branch adds only a fixed local producer adapter, not Work success. |
