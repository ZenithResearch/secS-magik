...
| `0x44` | `68` | `membership.provision` local production-shaped E2E descriptor. #77 fail-closes descriptor-only production runtime verification; live TCP evidence-ref/public-input support landed in #162; #160 implements bounded receiver-held resource-lock evidence; #144/M15.8 reconciles the bounded M15.8 resource-lock / attenuation boundary without claiming live proof/finality; handler binding is not authority and #144/M15.8 is the bounded local demo/status boundary. |
