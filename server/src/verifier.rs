...
pub enum VerificationError {
    ...
    AuthorityModeDowngrade,
    ReservedAuthorityMode,
    StaleDreggRevocationRoot,
    InvalidDreggRevocationProof,
    InvalidDreggFinalityQc,
    UnsupportedDreggFinalityCommittee,
...
impl VerificationError {
    pub fn reason_code(&self) -> &'static str {
        match self {
            ...
            Self::UnsupportedAuthorityMode => "unsupported_authority_mode",
            Self::AuthorityModeDowngrade => "authority_mode_downgrade",
            Self::ReservedAuthorityMode => "reserved_authority_mode",
            ...
            Self::UnsupportedDreggFinalityCommittee => "unsupported_dregg_finality_committee",
